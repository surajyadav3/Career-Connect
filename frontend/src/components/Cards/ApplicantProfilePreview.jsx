...
const ApplicantProfilePreview = ({
  ...
  // Choose avatar field dynamically
  const avatarUrl =
    selectedApplicant?.applicant?.avatar ||
    selectedApplicant?.applicant?.profilePic ||
    "";
        ...
        <div className="p-6">
          <div className="text-center mb-6">
            {avatarUrl ? (
              ...
              <div className="h-20 w-20 rounded-full bg-blue-100 flex items-center justify-center mx-auto text-2xl font-semibold text-blue-600">
