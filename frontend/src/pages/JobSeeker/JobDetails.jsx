  ...
  const applyToJob = async () => {
    try {
      if (jobId) {
        ...
        getJobDetailsById(); // refresh status
      }
    } catch (err) {
      ...
      <div className="container mx-auto pt-24">
        ...
        {jobDetails && (
          <div className="bg-white p-6 rounded-lg shadow-md space-y-8">
            {/* Hero section */}
            <div className="relative px-0 pb-8 border-b border-gray-100 flex justify-between items-start">
              ...
              <div>
                {jobDetails?.applicationStatus ? (
                  ...
                  <button
                    className="bg-gradient-to-r from-blue-500 to-blue-600 text-sm text-white px-6 py-2.5 rounded-xl hover:opacity-90 transition-all duration-200 font-semibold transform hover:-translate-y-0.5"
                    onClick={applyToJob}
                  >
                    Apply Now
                  </button>
