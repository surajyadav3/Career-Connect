              ...
              <div className="p-8">
                ...
                <div className="flex justify-end space-x-4 mt-8 pt-6 border-t">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center space-x-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {saving ? (
